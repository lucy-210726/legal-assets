...
payload.userEmail = USER_EMAIL || ''; payload.sessionToken = window.SESSION_TOKEN;
try {
var result = await new Promise(function(resolve, reject) {

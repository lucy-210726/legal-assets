...
function selectContractType(id){ currentContract=CONTRACTS.find(function(c){return c.id===id;}); renderForm(); document.getElementById('contract-list-view').style.display='none'; document.getElementById('contract-form-view').style.display='block'; document.getElementById('contract-modified-review-view').style.display='none'; window.scrollTo({top:0,behavior:'smooth'}); }
function renderForm(){

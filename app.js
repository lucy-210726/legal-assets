...
function selectContractType(id){ currentContract=CONTRACTS.find(function(c){return c.id===id;}); renderForm(); document.getElementById('contract-list-view').style.display='flex'; document.getElementById('contract-form-view').style.display='block'; window.scrollTo({top:0,behavior:'smooth'}); }
function renderForm(){

...
function selectContractType(id){ currentContract=CONTRACTS.find(function(c){return c.id===id;}); ; document.getElementById('contract-list-view').style.display='none'; document.getElementById('contract-form-view').style.display='block'; window.scrollTo({top:0,behavior:'smooth'}); }
function renderForm(){

...
var CONTRACTS_DATA = [
  ...
  },
  {
  ...
  },
   {
    ...
    { name: 'lite_sub', label: '금액 (KRW)', type: 'textarea', span: 2, linkedTo: 'LITE 플랜 선택',
    ...
    { name: 'standard_sub', label: '금액 (KRW)', type: 'textarea', span: 2, linkedTo: 'STANDARD 플랜 선택',
    ...
    { name: 'pro_sub', label: '금액 (KRW)', type: 'textarea', span: 2, linkedTo: 'PROFESSIONAL 플랜 선택',
    ...
    { name: 'total_month_fee', label: '월 기본 이용료 (원)',  type: 'text', required: true, format: 'currency', hint: '숫자만 기재하세요'  },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'total_fee',      label: '총 이용료 (원)',    type: 'text', required: true, format: 'currency', hint: '숫자만 기재하세요' },
      { name: 'total_month_fee', label: '월 구독료 (원)',   type: 'text', required: true, format: 'currency', hint: '숫자만 기재하세요' }, 
      { section: '지급 조건' },
  ...
  },
  {
    ...
    { name: 'support_fee',  label: 'Support 금액 (원)', type: 'text', format: 'currency', hint: '숫자만 기재하세요', linkedTo: 'Support 선택' },
    { name: 'use_discount', label: '할인적용', type: 'checkbox', span: 2 },
    { name: 'discount_per', label: '할인율 (%)',     type: 'text', hint: '숫자만 기재하세요.', linkedTo: '할인적용' },
    { name: 'discount_fee', label: '할인 금액 (원)', type: 'text', format: 'currency', hint: '숫자만 기재하세요', linkedTo: '할인적용' },
  ...
  },
 {
  ...
  },
  {
    ...
    { name: 'contract_date', label: '계약 체결일',            type: 'date', required: true },
    { name: 'contractName',  label: '계약명',                 type: 'text', required: true, span: 2 },
    { name: 'service_cost',  label: '용역대금 (부가세 별도)', type: 'text', required: true, span: 2 , format: 'currency', hint: '숫자만 기재하세요.' },
    { name: 'service_start', label: '용역 시작일',            type: 'date', required: true },
    { name: 'service_end',   label: '용역 종료일',            type: 'date', required: true },
    { section: '대금 지급' },
    { name: 'invoice_date',   label: '세금계산서 발행일', type: 'text', required: true, defaultValue: '용역완료월의 말일', hint: '예: 매월 말일, 별도 협의 등' },

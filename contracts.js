...
var CONTRACTS_DATA = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'fee_1', label: '금액 (KRW)', type: 'text', required: false, linkedTo: '사용량 인덱스' },
      { name: 'etc_1', label: '비고',       type: 'text', required: false, linkedTo: '사용량 인덱스' },
      { name: 'fee_2', label: '금액 (KRW)', type: 'text', required: false, linkedTo: '앱 마켓 인덱스' },
      { name: 'etc_2', label: '비고',       type: 'text', required: false, linkedTo: '앱 마켓 인덱스' },
      { name: 'fee_3', label: '금액 (KRW)', type: 'text', required: false, linkedTo: '소비 인덱스' },
      { name: 'etc_3', label: '비고',       type: 'text', required: false, linkedTo: '소비 인덱스' },
      { name: 'fee_4', label: '금액 (KRW)', type: 'text', required: false, linkedTo: 'TV 애드 인덱스' },
      { name: 'etc_4', label: '비고',       type: 'text', required: false, linkedTo: 'TV 애드 인덱스' },
      { name: 'fee_5', label: '금액 (KRW)', type: 'text', required: false, linkedTo: '모바일인덱스 GAME' },
      { name: 'etc_5', label: '비고',       type: 'text', required: false, linkedTo: '모바일인덱스 GAME' },
      { section: '할인 및 합계' },
      { name: 'fee_6',           label: '최종 할인적용 금액', type: 'text',   required: false },

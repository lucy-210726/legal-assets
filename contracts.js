...
var CONTRACTS_DATA = [
  ...
  },
  {
  ...
  },
   {
    ...
    { name: 'lite_text', label: '제공 기능', type: 'textarea', linkedTo: 'LITE 플랜 선택',
      defaultValue: '- 통합ID 시스템 (회원/비회원/익명)\n- 홈 대시보드 및 캠페인 통합 지표\n- 고객 행동 및 프로필 분석\n- 발송 캠페인별 성과 분석\n- 오프사이트 캠페인\n- 온사이트 캠페인 (인앱 메시지)\n- 글로벌 발송 피로도 관리\n- AI Agent (클레어, 이안)\n- 콘솔 접근권한\n- 2차 인증 (Two-Factor)',
      hint: '제공 기능을 수정할 수 있습니다.' },
    { name: 'lite_offer', label: '월 약정 제공량', type: 'textarea', linkedTo: 'LITE 플랜 선택',
    ...
    { name: 'standard_sub', label: '금액 (KRW)', type: 'textarea', linkedTo: 'STANDARD 플랜 선택',
      ...
      hint: '금액 조건을 수정할 수 있습니다.' },
    { name: 'standard_text', label: '제공 기능', type: 'textarea', linkedTo: 'STANDARD 플랜 선택',
      defaultValue: '- LITE 플랜 기능 전체 포함\n- 캠페인 자동화\n- 웹훅(WebHook), 로우데이터 추출\n- 오디언스 싱크 · 타겟팅 광고\n- DMP 기본 리포트',
      hint: '제공 기능을 수정할 수 있습니다.' },
    { name: 'standard_offer', label: '월 약정 제공량', type: 'textarea', linkedTo: 'STANDARD 플랜 선택',
    ...
    { name: 'pro_sub', label: '금액 (KRW)', type: 'textarea', linkedTo: 'PROFESSIONAL 플랜 선택',
      ...
      hint: '금액 조건을 수정할 수 있습니다.' },
    { name: 'pro_text', label: '제공 기능', type: 'textarea', linkedTo: 'PROFESSIONAL 플랜 선택',
      defaultValue: '- STANDARD 플랜 기능 전체 포함\n- DMP 고급 리포트\n- 보안 감사 대응',
      hint: '제공 기능을 수정할 수 있습니다.' },
    { name: 'pro_offer', label: '월 약정 제공량', type: 'textarea', linkedTo: 'PROFESSIONAL 플랜 선택',

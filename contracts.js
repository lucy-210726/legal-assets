...
var CONTRACTS_DATA = [
  ...
  { section: '사용량 인덱스' },
  { name: 'fee_1', label: '금액 (KRW)',  type: 'text', required: false },
  { name: 'etc_1', label: '비고',        type: 'text', required: false },
  { section: '앱 마켓 인덱스' },
  { name: 'fee_2', label: '금액 (KRW)',  type: 'text', required: false },
  { name: 'etc_2', label: '비고',        type: 'text', required: false },
  { section: '소비 인덱스' },
  { name: 'fee_3', label: '금액 (KRW)',  type: 'text', required: false },
  { name: 'etc_3', label: '비고',        type: 'text', required: false },
  { section: 'TV 애드 인덱스' },
  { name: 'fee_4', label: '금액 (KRW)',  type: 'text', required: false },
  { name: 'etc_4', label: '비고',        type: 'text', required: false },
  { section: '모바일인덱스 GAME' },
  { name: 'fee_5', label: '금액 (KRW)',  type: 'text', required: false },
  { name: 'etc_5', label: '비고',        type: 'text', required: false },
  { section: '할인 및 합계' },

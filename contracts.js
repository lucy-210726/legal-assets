...
var CONTRACTS_DATA = [
  ...
  },
  {
   ...
   { section: '서비스 신청내역' },
    { name: 'plan_type', label: '플랜 선택', type: 'radio', required: true, span: 2,
      options: ['LITE', 'STANDARD', 'PROFESSIONAL'] },
    { name: 'lite_sub', label: '금액(KRW, 부가세 별도)', type: 'textarea', span: 2, linkedTo: 'LITE',
      defaultValue: '기본 이용료 1,687,500원 / 월\n12개월 약정 시\n기본 이용료 1,350,000원 / 월\n(장기약정할인금액 337,500원 / 월)',
      hint: '금액 조건을 수정할 수 있습니다.' },
    { name: 'lite_text', label: '제공 기능', type: 'textarea', span: 2, linkedTo: 'LITE',
      defaultValue: '- 통합ID 시스템 (회원/비회원/익명)\n- 홈 대시보드 및 캠페인 통합 지표\n- 고객 행동 및 프로필 분석\n- 발송 캠페인별 성과 분석\n- 오프사이트 캠페인\n- 온사이트 캠페인 (인앱 메시지)\n- 글로벌 발송 피로도 관리\n- AI Agent (클레어, 이안)\n- 콘솔 접근권한\n- 2차 인증 (Two-Factor)',
      hint: '제공 기능을 수정할 수 있습니다.' },
    { name: 'lite_offer', label: '월 약정 제공량', type: 'textarea', span: 2, linkedTo: 'LITE',
      defaultValue: '- MAU : 300,000\n- 이벤트 : 30,000,000건\n- 인앱푸시 : 3,600,000건\n- 인앱메시지 : 3,600,000건',
      hint: '월 약정 제공량을 수정할 수 있습니다.' },
    { name: 'standard_sub', label: '금액(KRW, 부가세 별도)', type: 'textarea', span: 2, linkedTo: 'STANDARD',
      defaultValue: '기본 이용료 4,000,000원 / 월\n12개월 약정 시\n기본 이용료 3,200,000원 / 월\n(장기약정할인금액 800,000원 / 월)',
      hint: '금액 조건을 수정할 수 있습니다.' },
    { name: 'standard_text', label: '제공 기능', type: 'textarea', span: 2, linkedTo: 'STANDARD',
      defaultValue: '- LITE 플랜 기능 전체 포함\n- 캠페인 자동화\n- 웹훅(WebHook), 로우데이터 추출\n- 오디언스 싱크 · 타겟팅 광고\n- DMP 기본 리포트',
      hint: '제공 기능을 수정할 수 있습니다.' },
    { name: 'standard_offer', label: '월 약정 제공량', type: 'textarea', span: 2, linkedTo: 'STANDARD',
      defaultValue: '- MAU : 1,000,000\n- 이벤트 : 150,000,000건\n- 인앱푸시 : 12,000,000건\n- 인앱메시지 : 10,000,000건',
      hint: '월 약정 제공량을 수정할 수 있습니다.' },
    { name: 'pro_sub', label: '금액(KRW, 부가세 별도)', type: 'textarea', span: 2, linkedTo: 'PROFESSIONAL',
      defaultValue: '기본 이용료 7,500,000원 / 월\n12개월 약정 시\n기본 이용료 6,000,000원 / 월\n(장기약정할인금액 1,500,000원 / 월)',
      hint: '금액 조건을 수정할 수 있습니다.' },
    { name: 'pro_text', label: '제공 기능', type: 'textarea', span: 2, linkedTo: 'PROFESSIONAL',
      defaultValue: '- STANDARD 플랜 기능 전체 포함\n- DMP 고급 리포트\n- 보안 감사 대응',
      hint: '제공 기능을 수정할 수 있습니다.' },
    { name: 'pro_offer', label: '월 약정 제공량', type: 'textarea', span: 2, linkedTo: 'PROFESSIONAL',
  ...
  },
  {
    ...
    fields: [
      ...
      { section: '이용권한' },
      { name: 'channel',  label: '채널 수량',  type: 'text', required: true, format: 'currency', hint: '숫자만 기재하세요'  },
      { name: 'etc_4',    label: '채널 비고',  type: 'text', required: false },
      { name: 'account',  label: '계정 수량',  type: 'text', required: true, format: 'currency', hint: '숫자만 기재하세요'  },

...
var CONTRACTS_DATA = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'fee_1', label: '사용량 인덱스 금액',       type: 'text', required: false },
      { name: 'etc_1', label: '사용량 인덱스 비고',       type: 'text', required: false },
      { name: 'fee_2', label: '앱 마켓 인덱스 금액',      type: 'text', required: false },
      { name: 'etc_2', label: '앱 마켓 인덱스 비고',      type: 'text', required: false },
      { name: 'fee_3', label: '소비 인덱스 금액',         type: 'text', required: false },
      { name: 'etc_3', label: '소비 인덱스 비고',         type: 'text', required: false },
      { name: 'fee_4', label: 'TV 애드 인덱스 금액',      type: 'text', required: false },
      { name: 'etc_4', label: 'TV 애드 인덱스 비고',      type: 'text', required: false },
      { name: 'fee_5', label: '모바일인덱스 GAME 금액',   type: 'text', required: false },
      { name: 'etc_5', label: '모바일인덱스 GAME 비고',   type: 'text', required: false },

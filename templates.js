...
<div class="attach-zone" onclick="document.getElementById('inq-attach-input').click()" style="min-height:auto;padding:16px;"><input type="file" id="inq-attach-input" multiple onchange="handleAttachSelect('inq')"><div class="attach-zone-icon" style="font-size:1.3rem;margin-bottom:4px;">📎</div><div class="attach-zone-text" style="font-family:var(--font);"><strong style="font-size:0.85rem;">클릭하거나 드래그하여 첨부</strong><br><span style="font-size:0.75rem;color:var(--gold);">모든 형식 · 파일당 최대 20MB · 링크로 전송 · 3영업일 후 자동 삭제</span>

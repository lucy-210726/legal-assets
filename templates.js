...
<span style="font-family:var(--font);font-size:0.82rem;color:var(--text-muted);"><strong>파일 첨부</strong> · 클릭하거나 드래그 하여 첨부 (PDF, Word, HWP 등 · 파일당 최대 20MB)</span>
</div>
</div>
...
<div style="display:flex;align-items:center;gap:10px;justify-content:center;">
<span style="font-size:1.1rem;">📎</span>
<span style="font-family:var(--font);font-size:0.82rem;color:var(--text-muted);"><strong>파일 첨부</strong> (선택) · 클릭하거나 드래그 하여 첨부</span>
</div>
</div>

...
<div id="contract-list-view" style="display:none;">
<div class="sticky-head">
<button class="page-back" onclick="showContractTypeSelect()">← 유형 선택으로</button>
<div class="section-label">Contract Generator</div>
<div class="page-title">표준계약서 작성</div>
<div class="page-subtitle" style="margin-bottom:20px;">계약서 유형을 선택하면 작성폼으로 이동합니다</div>
<div class="company-tabs"><button class="company-tab active" onclick="filterCompany('IGAW',event)">IGAW</button><button class="company-tab" onclick="filterCompany('ADP',event)">ADP</button></div>
<div class="search-bar" style="margin-bottom:0;"><input type="text" id="contract-search" placeholder="계약서명 검색" oninput="filterContractGrid()"></div>
</div>
<div class="contract-type-grid" id="contract-grid" style="margin-top:20px;"></div>
</div>
...
PAGE_TEMPLATES.reference = `<div class="contract-page">
<div class="sticky-head">
